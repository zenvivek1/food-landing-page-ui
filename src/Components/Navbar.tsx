  ...
  return (
    <div className='min-h-15 w-full flex items-center justify-around bg-zinc-100 flex-wrap gap-4 py-5'>
        ...
        <div className='text-center'>
            <span className='text-black font-bold'>Deliver to : <i className="ri-map-pin-2-fill text-orange-500"></i></span>
        ...
        <div className='flex items-center px-4'>
          ...
          <button className='px-4 py-1 text-orange-500 font-bold ml-6 shadow-[0px_13px_26px_-4px] rounded shadow-amber-500 cursor-pointer transition ease hover:scale-105'><i className="ri-user-fill fill-amber-400 mr-1"></i>Login</button>
        </div>
    </div>
  )
}
